...
1. Go to the Run menu, which is the 2nd Codio menu from the right.
1. Select `Configure Project`.

Alternatively, open the terminal (Tools>Terminal) and enter

    bash symfonyconfig.sh
    
##To Access your Project##

To get to your Symfony site

1. Go to the Preview menu - the right most Codio menu, 
1. Then select `Symfony Config`.

and you should see the Symfony welcome page.

##Other
All components you need for Symfony are preinstalled by the Codio Starter Pack.
